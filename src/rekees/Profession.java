 ...
 * attributes for each rekees.Profession.
 *
 * @author Terry Weiss
 */
public enum Profession {
    ...
    /**
     * Calculates the rekees.Profession's Fortitude modifier.
     *
     * @param level rekees.Character's current level
     * @return rekees.Profession's modifier of the WillSave save
     ...
     *
     * @param level rekees.Character's current level
     * @return rekees.Profession's modifier of the FortitudeSave save
     * @throws IndexOutOfBoundsException If saving throw strength isn't valid
     */
    ...
    /**
     * Calculates the rekees.Profession's Reflex modifier.
     *
     * @param level rekees.Character's current level
     * @return rekees.Profession's modifier of the ReflexSave save
     * @throws IndexOutOfBoundsException If saving throw strength isn't valid
     */
    ...
    /**
     * String label of the given rekees.Profession, using its name in Capital Case
     *
     * @return rekees.Profession's name in Capital Case
     */
    @Override
